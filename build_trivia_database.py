...
def main():
    ...
    with conn:
        ...
        astronomy_trivia_1 = ('1', 'Pluto is a planet.', 'FALSE')
        astronomy_trivia_2 = ('2', 'There are more possible moves in a game of chess then there are atoms in the universe', 'TRUE')
        astronomy_trivia_3 = ('3', 'Mercury is the hottest planet in the solar system.', 'FALSE')
        astronomy_trivia_4 = ('4', 'At the end of its life, the Sun will collapse into a black hole.', 'FALSE')
        astronomy_trivia_5 = ('5', 'There are more trees on earth than there are stars in the Milky Way.', 'TRUE')
        astronomy_trivia_6 = ('6', 'Venus is the brightest celestial object in the sky.', 'FALSE')
        astronomy_trivia_7 = ('7', 'The diameter of a neutron star is about the length of Manhattan Island.', 'TRUE')
        astronomy_trivia_8 = ('8', 'Like the Sun, Jupiter is mostly composed of hydrogen and helium.', 'TRUE')
        astronomy_trivia_9 = ('9', 'High-mass stars will continue fusing lighter elements into heavier elements (hydrogen into helium, helium into carbon) up until lead (Pb), when the star implodes and rebounds in a supernova.', 'FALSE')
        astronomy_trivia_10 = ('10', 'The lower the mass of a star, the longer it lives.', 'TRUE')
        ...
        elapids_trivia_1 = ('1', 'The king cobra, the longest and largest venomous snake in the world, in addition to envenomation, will also constrict small prey.', 'FALSE')
        ...
        elapids_trivia_5 = ('5', 'Of the four recognized extant mamba species - the black mamba, the western green mamba, the eastern green mamba, and the Jameson\'s mamba - three are arboreal (tree dwelling).', 'TRUE')
