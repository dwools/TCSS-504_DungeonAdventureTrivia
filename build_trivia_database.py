...
def main():
    ...
    with conn:
        ...
        elapids_trivia_7 = ('Turtle-headed sea snakes, due to a specialized diet of fish egs, have only vestigial (small remnants of a once more significant characteristic) fangs and do not produce venom.', 'TRUE')
