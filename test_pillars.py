...
class PillarsUnitTests(unittest.TestCase):
    def setUp(self):
        ...
        self.__game.set_player_images(pg.transform.scale(self.__priestess.get_sprite_north(), self.__game.get_player_img_size()),
    ...
    def test_pillar_collision(self):
        """
        Test for the successful collision of player and Pillar object when they occupy the same space
        :return:
        """
